...
description: Use when building or modifying the LangGraph AI orchestration layer. Covers ilmu-glm-5.1 integration, thinking mode, tool calling, Langfuse tracing.
---

## ilmu-glm-5.1 Integration Pattern
...
## Thinking Mode
ilmu-glm-5.1 supports thinking via `extra_body={"thinking": {"type": "enabled"}}`.
